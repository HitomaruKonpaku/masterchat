...
export function liveReloadContinuation(
  origin: CVPair,
...
export function replayReloadContinuation(
  origin: CVPair,
...
export function sendMessageParams(to: CVPair): string {
  return b64e(cc([ld(1, cvToken(to)), vt(2, 2), vt(3, 4)]), B64Type.B2);
}

export function removeMessageParams(
  chatId: string,
  origin: CVPair,
...
export function pinParams(chatId: string, origin: CVPair) {
  return b64e(
    ld(1, [
      ld(1, cvToken(origin)),
...
export function unpinParams(actionId: string, origin: CVPair) {
  return b64e(
    ld(1, [
      ld(1, cvToken(origin)),
...
export function addModeratorParams(
  tgt: string,
  origin: CVPair,
  undo: boolean = false
) {
  // TODO: support undo op
  b64e(cc([ld(1, cvToken(origin)), ld(2, ld(1, truc(tgt)))]), B64Type.B2);
}

export function getContextMenuParams(
  chatId: string,
...
export function getTranscriptParams(
  videoId: string,
  language: string,
...
export function transcriptFormatToken(
  language: string,
  autoGenerated: boolean = true
) {
  return b64e(
    cc([ld(1, autoGenerated ? "asr" : ""), ld(2, language), ld(3, "")]),
    B64Type.B1
  );
}
...
function chatToken(chatId: string) {
